...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_QSPI_NOR, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NEWLIB_LIBC_MIN_REQUIRED_HEAP_SIZE, 12288);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_DEVICE_PRODUCT_ID, 32768);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_IPV6_MLD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_IF_MCAST_IPV6_ADDR_COUNT, 14);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_OTA_REQUESTOR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_EXTENDED_DISCOVERY, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IEEE802154_NRF5_RX_STACK_SIZE, 1024);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MBEDTLS_X509_CREATE_C, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MBEDTLS_X509_CSR_WRITE_C, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_CSL_MIN_RECEIVE_ON, 300);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ECDH_LIB_TINYCRYPT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ECDH_STACK_SIZE, 1200);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DFU_MULTI_IMAGE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DFU_MULTI_IMAGE_MAX_IMAGE_COUNT, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DFU_MULTI_IMAGE_PACKAGE_BUILD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DFU_MULTI_IMAGE_PACKAGE_APP, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_DEVICE_SOFTWARE_VERSION, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_DEVICE_SOFTWARE_VERSION_STRING, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_OTA_IMAGE_BUILD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_OTA_IMAGE_FILE_NAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_OTA_IMAGE_EXTRA_ARGS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MATTER_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MATTER_LOG_LEVEL, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_OTA_REQUESTOR_BUFFER_SIZE, 1024);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CHIP_OTA_REQUESTOR_REBOOT_ON_APPLY, 1);
